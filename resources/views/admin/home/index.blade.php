                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="col-md-4">
                                            <canvas id="offersLocations" height="110" width="110" style="margin: 5px 10px 10px 0"></canvas>
                                            <h4 style="margin:0"> Offers Locations </h4>
                                        </div>
                                        <div class="col-md-4">
                                            <canvas id="gender" height="110" width="110" style="margin: 5px 10px 10px 0"></canvas>
                                            <h4 style="margin:0"> Gender </h4>
                                        </div>
                                        <div class="col-md-4">
                                            <canvas id="onlineOfflineProviders" height="110" width="110" style="margin: 5px 10px 10px 0"></canvas>
                                            <h4 style="margin:0"> Online And Offline Providers </h4>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
...
echarts.init(document.getElementById('offersLocations')).setOption({
                //var chart = echarts.init(document.getElementById('offersLocations'), null, {
