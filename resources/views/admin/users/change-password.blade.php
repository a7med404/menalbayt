                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['url' => ['cpanel/users/'.$userInfo->id.'/update-password'], 'method' => "PATCH"]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::password('password', ['id' => 'password', 'class' => "form-control {{ $errors->has('password') ? ' is-invalid' : '' }}", 'value' => "{{ old('password') }}", 'placeholder' => 'Password', 'required']) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::password('password_confirmation', ['id' => 'password-confirm', 'class' => "form-control {{ $errors->has('password') ? ' is-invalid' : '' }}", 'value' => "{{ old('password') }}", 'placeholder' => 'Confirm Password', 'required']) !!}
                                </div>
                            </div>
