    ...
    <div class="x_content">
        ...
        <div class="row">
            <div class="col-md-3 custom-input">
                {!! Form::password('old_password', null, ['id' => 'old_password', 'class' => " {{ $errors->has('old_password') ? ' is-invalid' : '' }}", 'value' => "{{ old('old_password') }}", 'required', 'autofocus']) !!}
                {!! Form::label('old_password', 'Old Password', ['class' => 'custom-lable']) !!}
            </div>
        </div>
        </hr>
        <div class="row">
            <div class="col-md-3 custom-input">
                ...
                {!! Form::label('password', 'New Password', ['class' => 'custom-lable']) !!}
            </div>
            <div class="col-md-3 custom-input">
                ...
                {!! Form::label('password-confirm', 'New Password Confirm', ['class' => 'custom-lable']) !!}  
            </div>
        </div>
