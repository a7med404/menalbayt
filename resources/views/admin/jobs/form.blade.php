                    ...
                    <div class="form-group row">
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('name', 'Job Name', ['class' => 'custom-lable']) !!}   
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-3 custom-input">
                            {!! Form::label('department', 'Department') !!}
                            {!! Form::select('department', getSelect('department'), null, ['id' => 'department', 'placeholder' => 'Select The Department', 'class' => "form-control {{ $errors->has('department') ? ' is-invalid' : '' }}", 'value' => "{{ old('department_id') }}", 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    @if(isset($jobInfo->image) )
                        <div class="form-group row">
                            <div class="col-md-3 custom-lable-checkbox-radio">
                                ...
                                <img src="{{ asset('storage/images/jobs/'.$jobInfo->image) }}" alt="job image" width="120px" height="90px">
                            </div>
                        </div>
                    @endif
                    <div class="form-group row">
