                ...
                <div class="row">
                    <div class="col-lg-12  float-right">
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-user"></i>Jobs Informations</li>						  	
                        </ol>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
                <!-- End  Breadcrumb -->
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          ...
                          <p class="text-center"><img src="{{ getJobImageOrDefaultImage($jobInfo->image) }}"
                      ...
                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> {{ status()[$jobInfo->status] }}
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> {{ $jobInfo->department->name }}
                        </li>
                      </ul>

                      <a href="{{ route('jobs.edit', ['id' => $jobInfo->id]) }}" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                      <br />
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <!-- start Last Offers -->
                            <ul class="messages">
                              @foreach($jobInfo->offers as $offer) 
                              <li>
                                {{-- <img src="{{ getJobImageOrDefaultImage($offer->image) }}" class="avatar" alt="Avatar"> --}}
