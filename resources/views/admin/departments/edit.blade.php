                        ...
                        <div class="row">
                            <div class="col-lg-12  float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li><i class="fa fa-user"></i>Edit Department Information</li>						  	
                                </ol>
                            </div><!-- /.col-lg-12 -->
                        </div><!-- /.row -->
                        <!-- End  Breadcrumb -->
                        
                        {!! Form::model($departmentInfo, ['route' => ['departments.update', $departmentInfo->id], 'method' => "PATCH", 'class' => 'form', 'files' => true]) !!}
